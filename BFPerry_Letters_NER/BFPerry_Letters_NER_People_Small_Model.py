...
try:
    ...
    print("Model 'en_core_web_sm' not installed. Install with:")
    print("    python3 -m spacy download en_core_web_sm")
    exit(1)

input_folder = Path("/Users/crboatwright/PerryLetters/BFPerryLettersSeparated")
output_file = Path("/Users/crboatwright/PerryLetters/BFPerry_Letters_NER/BFPPeopleOnlySmallModel.txt")
...
with output_file.open("w", encoding="utf-8") as out:
    out.write(f"=== PERSON entities from {input_folder.name} folder (en_core_web_sm) ===\n\n")
